  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto px-6 py-12 max-w-5xl">
        ...
        {/* Membership Pricing */}
        <Card className="bg-gradient-to-br from-card to-muted/20 border-primary/30 mb-12">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl text-primary mb-2">Premium Membership</CardTitle>
            <div className="flex items-center justify-center space-x-2">
              <span className="text-4xl font-bold text-foreground">$97</span>
              <span className="body-text">/month</span>
            </div>
            <CardDescription className="body-text mt-4">
        ...
        <Card className="bg-primary/10 border-primary/30 mb-8">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-xl font-semibold text-primary mb-2">30-Day Money-Back Guarantee</h3>
        ...
        <div className="text-center space-y-6">
          <Button 
            className="bg-primary text-primary-foreground hover:bg-secondary hover:text-secondary-foreground px-12 py-4 text-xl font-semibold"
